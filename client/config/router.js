...
Router.route('/catalogo', function () {
    this.render('catalogo');
}, {
  name:"catalogo"
});
Router.route('/cotizacion', function () {
    this.render('cotizacion');
}, {
  name:"cotizacion"
});
Router.route('/selecbandeja', function () {
    this.render('selecbandeja');
}, {
  name:"selecbandeja"
});
Router.route('/distribuidores', function () {
    this.render('distribuidores');
}, {
  name:"distribuidores"
});
Router.route('/documentos', function () {
...
Router.route('/ayuda', function () {
    this.render('ayuda');
}, {
  name:"ayuda"
});
//nuevos gonvarri
Router.route('/encuestas/crear', function () {
    this.render('crearEncuesta');
}, {
  name:"crear.encuesta"
});
Router.route('/encuestas/cargar', function () {
    this.render('cargarDatos');
}, {
  name:"cargar.encuesta"
});
Router.route('/encuestas/lista', function () {
    this.render('listarEncuesta');
}, {
  name:"listar.encuesta"
});
Router.route('/encuestas/listaxls', function () {
    this.render('listaxlsDatos');
}, {
  name:"listaxls.encuesta"
});
...
Router.route('/login', function () {
    this.render('login');
    this.layout('blankLayout2')
});
Router.route('/loginold', function () {
    this.render('loginOld');
    this.layout('blankLayout')
});
